...
func UserID(v int) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUserID), v))
	})
}

// PollExpiry applies equality check predicate on the "pollExpiry" field. It's identical to PollExpiryEQ.
func PollExpiry(v time.Time) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPollExpiry), v))
	})
}
...
func UserIDEQ(v int) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUserID), v))
	})
}
...
func UserIDNEQ(v int) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
...
func UserIDIn(vs ...int) predicate.Question {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UserIDNotIn(vs ...int) predicate.Question {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
// PollExpiryEQ applies the EQ predicate on the "pollExpiry" field.
func PollExpiryEQ(v time.Time) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPollExpiry), v))
	})
}

// PollExpiryNEQ applies the NEQ predicate on the "pollExpiry" field.
func PollExpiryNEQ(v time.Time) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldPollExpiry), v))
	})
}

// PollExpiryIn applies the In predicate on the "pollExpiry" field.
func PollExpiryIn(vs ...time.Time) predicate.Question {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Question(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldPollExpiry), v...))
	})
}

// PollExpiryNotIn applies the NotIn predicate on the "pollExpiry" field.
func PollExpiryNotIn(vs ...time.Time) predicate.Question {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Question(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldPollExpiry), v...))
	})
}

// PollExpiryGT applies the GT predicate on the "pollExpiry" field.
func PollExpiryGT(v time.Time) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldPollExpiry), v))
	})
}

// PollExpiryGTE applies the GTE predicate on the "pollExpiry" field.
func PollExpiryGTE(v time.Time) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldPollExpiry), v))
	})
}

// PollExpiryLT applies the LT predicate on the "pollExpiry" field.
func PollExpiryLT(v time.Time) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldPollExpiry), v))
	})
}

// PollExpiryLTE applies the LTE predicate on the "pollExpiry" field.
func PollExpiryLTE(v time.Time) predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldPollExpiry), v))
	})
}
...
func HasAnswer() predicate.Question {
	return predicate.Question(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, AnswerTable, AnswerPrimaryKey...),
		)
